...
function App() {
    ...
    const extrasControll = v => {
        setExtras(e => ({...e, [v]: !e[v]})) //pakeitem objekto properti i priesinga
    }
                    ...
                    <div className='cb-bin'>
                        {
                            checkbox.map(c => <span key={c.value}>
                                <input type="checkbox" id={'cb_' + c.value} checked={extras[c.value]}
                    ...
                    <div className='cb-bin'>
                        {
                            radio.map(c => <span key={c.value}>
                                <input type="checkbox" id={'r_' + c.value} checked={payment===c.value}
