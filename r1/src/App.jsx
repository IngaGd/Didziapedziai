...
function App() {
    ...
    //custom hooks naudojam, kai salia kokio veiksmo reikia atlikti ir logine operacija
        ...
        <div className="App">
            <header className="App-header">
                <h1>
                    ...
                    <span style={{ color: 'orange', padding: '10px' }}>{count4}</span>
                </h1>
                ...
                <div className="sq-bin">
                    ...
                    {/* setCount4 count4 state keicia i priesinga */}
                </div>
            </header>
        </div>
    );
